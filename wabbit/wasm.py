...
class WasmCompiler(ScopeAwareModelVisitor):
    '''
    This Wabbit-to-Wasm Compiler is implemented as a ScopeAwareModelVisitor which evaluates wabbit, transpiling into
    web assembler fragments, and propgating up to each node to assist in transpilation.
    '''
    def __init__(self):
        self.env = ChainMap()
        self.errors = []
