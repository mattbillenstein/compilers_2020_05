...
model6 = Program(
    FunctionDefinition(
        ...
        body=Clause(
            ReturnStatement(
                expression=BinOp.add(left=Identifier("x"), right=Identifier("y"))
            )
        ),
    ),
    FunctionDefinition(
        ...
        body=Clause(
            ReturnStatement(
                expression=BinOp.mult(left=Identifier("x"), right=Identifier("y"))
            )
        ),
    ),
    FunctionDefinition(
    ...
    FunctionDefinition(
        name="print_factorials",
        parameters=(Parameter(name="last", type="int"),),
        rtype=None,
        body=Clause(
